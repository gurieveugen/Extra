    ...
    <div class="container myContent">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                <div id="imgCircle3" class="row left-row">
                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-6 text-center">
                        <img class="smallImage" src="img/AYaraliev.png" alt="">
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
                <h4 class="link"><a href="#">We build new age application (ACR, real time state chat...)</a> <span style="margin-left: 20px;">10.12.2013</span></h4>
                <h4 class="link"><a href="#">We build new age application (ACR, real time state chat...) new age application new age application new age application new age application new age application new age application new age application</a><span style="margin-left: 20px;">10.12.2013</span></h4>
                <h4 class="link"><a href="#">We build new age application (ACR, real time state chat...)</a><span style="margin-left: 20px;">10.12.2013</span></h4>
                <h4 class="link"><a href="#">We build new age application (ACR, real time state chat...)</a><span style="margin-left: 20px;">10.12.2013</span></h4>
        ...
        <!--<div style="background-color: aqua; height: 50px;  margin-top: 100px;"></div>-->
